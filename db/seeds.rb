...
game1= Game.create(local:"IPT",match_day:DateTime.new(2018,12,19,17,30),url: "someURL1", state:1, owner:player1, is_private:false);
game2= Game.create(local:"IPT",match_day:DateTime.new(2018,10,19,17,30),url: "someURL2", state:3, owner:player2);
game3= Game.create(local:"IPT",match_day:DateTime.new(2018,11,19,17,30),url: "someURL3", state:3, owner:player3);
game4= Game.create(local:"IPT",match_day:DateTime.new(2018,12,19,18,30),url: "someURL4", state:3, owner:player4);
game5= Game.create(local:"IPT",match_day:DateTime.new(2018,10,19,18,30),url: "someURL5", state:3, owner:player1);
game6= Game.create(local:"IPT",match_day:DateTime.new(2018,11,19,18,30),url: "someURL6", state:3, owner:player3);
